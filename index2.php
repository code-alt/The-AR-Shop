...
div {
  ...
  <ul id="scene" class="scene unselectable"
    ...
    <li class="layer" data-depth="0.20"><h1 class="title">The <em>AR</em> shop<br>Try <em>new AR models</em> here!</h1></li>
		...
		<a href="/get">
      <button style="position:fixed;left: 50%;bottom:25px;-webkit-transform:translateX(-50%);transform:translateX(-50%);text-align:center;width:150px;font-family:'open sans',sans-serif;">
			Try it now!
      </button></a>
			</main>
